...
def main():
    ...
    # construct model
    if cfg_model['architecture'] == 'att_unet':
        from models.attention_unet.att_unet import AttU_Net
        model = AttU_Net(img_ch=3, output_ch=cfg_model['classes'])

    elif cfg_model['architecture'] == 'segmenter':
